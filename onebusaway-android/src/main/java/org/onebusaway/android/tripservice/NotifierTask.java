...
public final class NotifierTask implements Runnable {
    ...
    private Notification createNotification(String notifyTitle,
        ...
        SharedPreferences appSettings = Application.getPrefs();

        boolean vibratePreference = appSettings.getBoolean("preference_vibrate_allowed", true);
        if (vibratePreference) {
            notifyBuilder.setDefaults(Notification.DEFAULT_VIBRATE);
        }

        String soundPreference = appSettings.getString("preference_notification_sound", "");
